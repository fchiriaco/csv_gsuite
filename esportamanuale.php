...
fclose($fileout);
echo '<p style="text-align:center">';
echo 'File per caricamento massivo utenti  G_SUITE creato correttamente (nome file utentiman.csv): <a href="utentiman.csv" title="scarica">APRI</a><br><br>';
