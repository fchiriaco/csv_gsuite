...
fclose($fileout);
echo '<p style="text-align:center">';
echo 'File per caricamento massivo utenti  G_SUITE creato correttamente (nome file utenticsv.csv): <a href="utenticsv.csv" title="scarica">APRI</a><br><br>';
